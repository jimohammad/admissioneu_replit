        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mt-6 w-full max-w-6xl mx-auto px-2">
            <Link href="/budget" className="block">
              <div 
                className="h-16 bg-slate-900/60 hover:bg-slate-900/80 border border-white/20 hover:border-blue-400 text-white rounded-xl flex items-center justify-center gap-2.5 px-4 text-base font-medium transition-all duration-200 cursor-pointer active:scale-[0.98]"
            ...
            <Link href="/calculator" className="block">
              <div 
                className="h-16 bg-slate-900/60 hover:bg-slate-900/80 border border-white/20 hover:border-amber-400 text-white rounded-xl flex items-center justify-center gap-2.5 px-4 text-base font-medium transition-all duration-200 cursor-pointer active:scale-[0.98]"
            ...
            <Link href="/rankings" className="block">
              <div 
                className="h-16 bg-slate-900/60 hover:bg-slate-900/80 border border-white/20 hover:border-yellow-400 text-white rounded-xl flex items-center justify-center gap-2.5 px-4 text-base font-medium transition-all duration-200 cursor-pointer active:scale-[0.98]"
            ...
            <Link href="/arrival-guide" className="block">
              <div 
                className="h-16 bg-slate-900/60 hover:bg-slate-900/80 border border-white/20 hover:border-cyan-400 text-white rounded-xl flex items-center justify-center gap-2.5 px-4 text-base font-medium transition-all duration-200 cursor-pointer active:scale-[0.98]"
            ...
            <Link href="/resources" className="block">
              <div 
                className="h-16 bg-slate-900/60 hover:bg-slate-900/80 border border-white/20 hover:border-slate-300 text-white rounded-xl flex items-center justify-center gap-2.5 px-4 text-base font-medium transition-all duration-200 cursor-pointer active:scale-[0.98]"
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <div 
                  className="h-16 bg-slate-900/60 hover:bg-slate-900/80 border border-white/20 hover:border-emerald-400 text-white rounded-xl flex items-center justify-center gap-2.5 px-4 text-base font-medium transition-all duration-200 cursor-pointer active:scale-[0.98]"
