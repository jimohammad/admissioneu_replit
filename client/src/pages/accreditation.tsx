  ...
  'India': {
    ...
    bodies: [
      ...
      },
      {
        ...
        acronym: 'AICTE',
        type: 'specialized',
        role: 'Accreditation for Engineering, Management, Pharmacy, Architecture, Hotel Management programs',
        website: 'https://www.aicte-india.org',
        established: '1945',
        notes: 'Subject: Engineering, MBA, MCA, Pharmacy, Architecture',
      },
      {
      ...
      },
      {
        ...
        acronym: 'NMC',
        type: 'specialized',
        role: 'Recognition of medical degrees (MBBS, MD, MS) from foreign universities',
        website: 'https://www.nmc.org.in',
        established: '2020',
        notes: 'Subject: Medicine - Replaced MCI',
      },
      {
        name: 'Bar Council of India',
        acronym: 'BCI',
        type: 'specialized',
        role: 'Recognition of law degrees for practicing in India',
        website: 'https://www.barcouncilofindia.org',
        established: '1961',
        notes: 'Subject: Law (LLB, LLM)',
      },
      {
        name: 'Council of Architecture',
        acronym: 'COA',
        type: 'specialized',
        role: 'Recognition of architecture degrees and registration of architects',
        website: 'https://www.coa.gov.in',
        established: '1972',
        notes: 'Subject: Architecture (B.Arch)',
      },
      {
        name: 'Pharmacy Council of India',
        acronym: 'PCI',
        type: 'specialized',
        role: 'Recognition of pharmacy degrees for practice in India',
        website: 'https://www.pci.nic.in',
        established: '1948',
        notes: 'Subject: Pharmacy (B.Pharm, M.Pharm)',
      },
      {
        name: 'Indian Nursing Council',
        acronym: 'INC',
        type: 'specialized',
        role: 'Recognition of nursing qualifications from foreign countries',
        website: 'https://www.indiannursingcouncil.org',
        established: '1947',
        notes: 'Subject: Nursing (BSc, MSc Nursing)',
      },
      {
        name: 'Dental Council of India',
        acronym: 'DCI',
        type: 'specialized',
        role: 'Recognition of dental degrees (BDS, MDS) for practice in India',
        website: 'https://www.dciindia.gov.in',
        established: '1948',
        notes: 'Subject: Dentistry',
      },
    ],
    process: 'Foreign degrees are evaluated by AIU for equivalence. Professional degrees require additional recognition from respective councils (NMC for medicine, BCI for law, etc.).',
  },
  'Pakistan': {
    flag: '🇵🇰',
    bodies: [
